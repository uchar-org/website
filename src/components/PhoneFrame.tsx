...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-366/729', className)} {...props}>
      ...
      <div className="absolute top-[calc(23/729*100%)] left-[calc(23/366*100%)] z-50 grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden rounded-4xl bg-linear-to-b from-brand-500 to-brand-100 pt-[calc(23/318*100%)]">
        {children}
      </div>
